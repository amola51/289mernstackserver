...
export const updateProduct = asyncError(async(req, res, next)=>{
    ...
    res.status(200).json({
        success:true,
        messag: "Product Uppdated Successfully",
    });
...
export const addProductImage = asyncError(async (req, res, next) => {
    ...
    res.status(200).json({
        success:true,
        messag: "Image Upload Successfully",
    });
...
export const deleteProductImage = asyncError(async (req, res, next) => {
    ...
    if(isExist < 0) return next(new ErrorHandler("Image Dose not Exist", 400));
    ...
    res.status(200).json({
        success:true,
        messag: "Image Delete Successfully",
    });
